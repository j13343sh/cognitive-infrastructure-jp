...
人間とAIが現実との対話を継続するための運営研究アーカイブである。
...
同時に、その力を適切に扱うための判断力・検証・責任も求められる。

AI運用論は、人間とAIがRealityとの対話を継続するための運営方法を探究するRepositoryである。
...
例えば、ペニシリンの発見は、汚染された培養皿を単なる失敗として廃棄せず、Observationとして扱ったことから始まった。予想外の現象はReality（現実）によって検証され、やがて医学史を大きく変える発見へとつながった。
...
まずReality Observation（現実の観察）として保持し、Realityによって検証することである。
...
これは、日本語版では理論を中心に整理し、英語版では運営事例・運営観測を継続的に蓄積するという編集方針によるものである。
