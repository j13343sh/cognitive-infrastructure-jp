...
認知基盤論では、理論だけでなく、実際の研究・運営を通じて得られたObservationもケーススタディとして整理している。

これらは理論の正しさを証明するものではなく、限定された環境で観測された実践記録である。

現在公開しているケーススタディは以下のとおりである。
...
今後も、新たなObservationが得られた場合は、必要に応じてケーススタディを追加する予定である。
